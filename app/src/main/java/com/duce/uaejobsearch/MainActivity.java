...
import com.duce.uaejobsearch.Adapters.MyAdapter;
...
import com.duce.uaejobsearch.local.UserInfoLocal;
    ...
    private  void sendRequestQueue(){
         new Thread(new Runnable() {
             ...
             public void run() {
                 ...
                 JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Config.BASE_URL + "posts?_embed",
